...
public class TopicServiceImpl implements TopicService {
    ...
    **/
    @Override
    public void getWithPageType(String topicId,String searchInfo, Page page, Map<String, Object> model) throws ResultException {
        ...
        if(topic.getPageType() == CommonConstants.PageType.SHOW_CHILD_TOPIC){
            ...
            if(StringUtils.isEmpty(searchInfo)){
                model.put("posts", postService.getTopicAll( page));
            }else{
                model.put("posts", postService.getTopicAllBySearchInfo(searchInfo, page));
            }
            model.put("page", page);
            ...
            if(StringUtils.isEmpty(searchInfo)){
                ...
                model.put("posts", postService.getByTopicIdAndSearchInfo(topicId, searchInfo, page));
            }
            model.put("page", page);
